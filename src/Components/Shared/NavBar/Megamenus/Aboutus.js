...
const Aboutus =()=>{
        ...
        <div className='nav-megamenuss Aboutus-menu'>
         <div className='menu-linkk'>
             ...
             <div className='inner-linkk'>
                 ...
                 <Link className='View-All-About'><FormattedMessage id='View' defaultMessage='View All'/>  <BsArrowRightCircle/></Link>
             </div>
         </div>
    ...
    <div className='Get-started'>
        <h5><FormattedMessage id='GetStarted' defaultMessage='Get Started'/></h5>

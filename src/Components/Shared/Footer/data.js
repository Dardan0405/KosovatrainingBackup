...
export const Footericons =[
    {
        icon:<FaFacebookF/>,
        link:'https://www.facebook.com/profile.php?id=61550784545121'
    },
    {
        icon: <BsTwitter/>,
        link:'https://twitter.com/kosovatraining'
    ...
    {
        icon:<FaTiktok/>,
        link:"https://www.tiktok.com/@kosovatraining"
    }
]
...
export const FooterData =[
    ...
    {
        category: <FormattedMessage id="Courses" defaultMessage="Courses"/>,
        links:[
            {
                link:<FormattedMessage id="Buss" defaultMessage="Business"/>,
                to:'/'
            },
            {
            ...
            {
                link:<FormattedMessage id="Desig" defaultMessage="Design"/>,
                to:'/'
            },
            {
            ...
            {
                link:<FormattedMessage id="pHo" defaultMessage="Photography"/>,
                to:'/'
    ...
    },
    {
        ...
        links:[
            ...
            {
                link:<FormattedMessage id="Affi" defaultMessage="Affiliate Login"/>,
                to:'/'
            },
            {
            ...
            {
                link:<FormattedMessage id="Sucess" defaultMessage="Success Stories"/>,
                to:'/'
            }
        ]
    },
    {
        ...
        links:[
            {
                link:<FormattedMessage id="HelpC" defaultMessage="Help center"/>,
                to:'/'
            },
            {
                link:<FormattedMessage id="ContactUs" defaultMessage="Contact us"/>,
                to:'/'
            },
            {
            ...
            {
                link:<FormattedMessage id="Our" defaultMessage="Blog"/>,
                to:'/'
            },
            {
                link:<FormattedMessage id="Careere" defaultMessage="Careers"/>,
                to:'/'
            }

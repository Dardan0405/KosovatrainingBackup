  ...
  const tabCount = 7;
    ...
    return(
        <div className="Recomaded-Coruse-Container">
            ...
            <span> <FormattedMessage id='Course' defaultMessage="Courses"/></span></h1>
                ...
                <TabList>
                  ...
                  onClick={() => setselectedTab((selectedTab + tabCount -1)% tabCount)} >
                    <MdKeyboardArrowLeft/>
                        ...
                        <Tab><FormattedMessage id="Desig" defaultMessage="Design"/></Tab>
                        <Tab><FormattedMessage id="DEV" defaultMessage="Development"/></Tab>
                        <Tab><FormattedMessage id="buss" defaultMessage="Business"/></Tab>
                        <Tab><FormattedMessage id="IT" defaultMessage="IT & Software"/></Tab>
                        <Tab><FormattedMessage id="pHo" defaultMessage="Photography"/></Tab>
                    ...
                    <Link><FormattedMessage id='Load' defaultMessage='Load More'/></Link>
                     </div>
                    </div>

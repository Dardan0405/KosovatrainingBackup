...
return(
   <div className="Kosova-Buiness-Image">
    ...
    <div className="Kosova-BusinessContent">
        ...
        <h4>
            <FormattedMessage id="Get" defaultMessage='Get KosovaTraining'/> <span> <FormattedMessage id="busss" defaultMessage="Business"/></span>
        </h4>
        <p>
        ...
        <Link><FormattedMessage id="GetStarted" defaultMessage="Get started"/></Link>
        </div>
    </div>
    </div>

...
const [dropdown, setDropdown] = useState(false);
    ...
    const handleSubmit =(e) =>{
        e.preventDefault();
        if(!name || !phone || !email ||  !education ||!surname){
            SetError(true)
        }
        else{
        axios({
...
.catch(function(response){
    ...
    return(
        <form onSubmit={handleSubmit}>
            ...
            <div className="inner-input">
                <p><FormattedMessage id="type1" defaultMessage="Type"/></p>
            ...
            <div className="input-container input-container2">
                <div className="inner-input">
                    <p><FormattedMessage id="Name" defaultMessage="Name"/></p>
                    <div className="input">
                        <span></span>
                ...
                <div className="inner-input">
                    <p><FormattedMessage id='Surname' defaultMessage='Surname' /></p>
                    <div className="input">
                        <span> </span>
                ...
                <div className="inner-input">
                    ...
                    <div className="input">
                        ...
                        <FormattedMessage id='phonenumber'>
                            {(msg) => (
                                <input 
                                    type="text" id='phonenumber' name='phone' 

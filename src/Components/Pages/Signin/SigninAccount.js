    ...
    return(
        <div className="background-signin">
          ...
          <div className="Text-Password-Signin">
            ...
            <div className="iin1">
            <span><FiLock/></span>
            <FormattedMessage id="CPass" defaultMessage=" Confrim Password">
                {(msg) =>(
                    <input 
                    type={hidden ? "password" : "text"}
                    id="pass"
       ...
       <div className="Check-Box-Signin">
        <label >
          ...
          <FormattedMessage id="SignupN" defaultMessage="Sign up for email newsletter (optional)"/>
          <p><FormattedMessage id="keep touch" defaultMessage="We would like to keep in touch and send you news and offers"/></p>
        </label>

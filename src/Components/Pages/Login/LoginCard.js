...
import student from "../../../assets/Home/WhyKosovaTraining/student.png"
...
const LoginCard =() =>{
    ...
    async function submit(e){
        e.preventDefault();
        try{
            await axios.post("http://localhost:3405/Login",{
                email,passowrd
            })
            .then(res  =>{
                if(res.data=="exist"){
...
return(
    ...
    <div className ="Button-Login">
        <button type="submit"><FormattedMessage id="log-in" defaultMessage="Log in"/></button>
    </div>
    ...
    <div className="Card3-Login">
        ...
        <p><FormattedMessage id="Total1" defaultMessage='Total Students'/></p>

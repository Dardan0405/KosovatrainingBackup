...
export const dataCards =[
    {
        ...
        Quote:Quote1,
        Quote2:Quote2,
        Description:<FormattedMessage id = "Istudied" defaultMessage="Kosova Training transformed my career.&nbsp; Knowledgeable instructors,&nbsp; hands-on experience,&nbsp; and industry-relevant curriculum prepared me for success.&nbsp; Highly recommended."/>,
        infoStudent:<FormattedMessage id="Albana" defaultMessage="Albana Uka"/>,
        status:<FormattedMessage id="ST1" defaultMessage= "(Student)" />
    },
    {
        icon:Icons1,
        Quote:Quote1,
        ...
        status:<FormattedMessage id="ST2" defaultMessage="(Student)"/>
    ...
    },
    {
        ...
        Quote:Quote1,
        Quote2:Quote2,
        Description:<FormattedMessage id = "I studied1" defaultMessage="Kosova Training played a pivotal role in shaping my career. The instructors' expertise and the hands-on experience offered a solid foundation for my success. The Training Center's impact on my professional journey has been remarkable, and I can't stress enough how beneficial the program was"/>,
    ...
    },
    {
        ...
        Quote:Quote1,
        Quote2:Quote2,
        Description:<FormattedMessage id="Help2" defaultMessage="Choosing Kosova Training was a turning point in my career journey. The interactive learning, combined with a comprehensive curriculum and expert guidance, elevated my skills and knowledge. The Training Center's influence on my career trajectory is undeniable, and I'm truly appreciative of the experience."/>,
...
export const DataBlog =[
    {
      ...
      Time:clock,
      date:<FormattedMessage id="04" defaultMessage="May 04,2023"/>,
      icon:eye,
